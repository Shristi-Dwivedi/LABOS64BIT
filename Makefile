...
build-x86_64: $(kernel_object_files) $(x86_64_object_files)
	mkdir -p dist/x86_64
	x86_64-elf-ld -m elf_x86_64 -n -o dist/x86_64/kernel.bin -T targets/x86_64/linker.ld \
		build/x86_64/boot/main.o \
		build/kernel/main.o \
		build/x86_64/boot/main64.o \
		$(filter-out build/x86_64/boot/main.o build/kernel/main.o build/x86_64/boot/main64.o, $(kernel_object_files) $(x86_64_object_files))
	cp dist/x86_64/kernel.bin targets/x86_64/iso/boot/kernel.bin
	grub-mkrescue /usr/lib/grub/i386-pc -o dist/x86_64/kernel.iso targets/x86_64/iso